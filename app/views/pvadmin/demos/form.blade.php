    ...
    {{ Form::horizontal(['route' => $action, 'class' => 'row', 'method' => $method]) }}
        <div class="col-sm-10">
            ...
            {{ ControlGroup::generate(
                ...
                Form::select('enterprise_version', array('PVE 10.4' => 'PVE 10.4', 'PVE 11' => 'PVE 11', 'PVE 11.4' => 'PVE 11.4', 'PVE 11.5' => 'PVE 11.5', 'Troux Insight 9.3' => 'Troux Insight 9.3'), $demo->enterprise_version, ['required']) . $errors->first('enterprise_version', '<span class="label label-danger">:message</span>'),
                null,
                3
            ) }}
            {{ ControlGroup::generate(
