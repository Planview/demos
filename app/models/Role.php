...
class Role extends EntrustRole
{
    ...
    /**
     * Get the ISR Admin role
     * @return object ISR Admin role
     */
    public static function isrAdminRole()
    {
        return self::where('name', '=', "ISR Admin")->firstOrFail();
    }
...
name, as you can imagine, is the name of the Role. 
...
It is an array that is automatically serialized and unserialized when the Model is saved. 
This array should contain the name of the permissions of the Role. 
